...
const ReportTypeSelector = ({ inquiryState, onFilterChange }) => {
  ...
  const Tahun = ["2025", "2024", "2023", "2022", "2021", "2020"];

  // Only one report type for inquiry-bansos
  const jenlapOpt = [{ value: "1", label: "Realisasi Bansos" }];
    ...
    <div className="mb-4">
      <div className="w-full p-3 mb-4 sm:p-4 bg-gradient-to-r from-purple-100 to-fuchsia-100 dark:from-zinc-900 dark:to-zinc-900 shadow-none rounded-2xl">
        ...
        <div className="flex flex-col md:flex-row gap-6 w-full">
          ...
          {/* Akumulatif Options as Dropdown */}
          <div className="flex-1">
            <label
              id="akumulatif-label"
