...
const AkumulasiModal = ({ isOpen, onClose, query, title, thang }) => {
  ...
  const getData = async () => {
    ...
    try {
      ...
      // Filter out any rows with kddept === "000" if needed
  ...
  // Determine which columns are numeric for formatting and totals
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex space-x-2">
                  <Input
                    ...
                    className="w-64"
                  />
                  <DataExport data={data} filename="data_akumulasi.csv" />
                </div>
              </div>
