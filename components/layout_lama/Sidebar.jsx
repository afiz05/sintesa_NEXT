    ...
    <>
      {statusLogin && (
        <>
          <aside
            id="sidebar"
            className={`sidebar ${isSidebarVisible ? "" : ""} ${darkMode ? "dark-mode" : "bg-light"
              }`}
          >
                    ...
                    <>
                      <li>
                        <Link
                          ...
                          className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "dashboard-profile"
                            ? "active"
                            : ""
                            }`}
                          as={Link}
                ...
                >
                  <li>
                    <Link
                      ...
                      className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "dashboard-mbg" ? "active" : ""
                        }`}
                      as={Link}
                    >
                      <i className="bi bi-circle"></i>
                  ...
                  <li>
                    <Link
                      ...
                      className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "kk-mbg" ? "active" : ""
                        }`}
                    >
                      <i className="bi bi-circle"></i>
                  ...
                  <li>
                    <Link
                      ...
                      className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "update-mbg" ? "active" : ""
                        }`}
                    >
                      <i className="bi bi-circle"></i>
                  ...
                  <li className="nav-item">
                    ...
                    >
                      <li>
                        <Link
                          as={Link}
                          className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "epa" ? "active" : ""
                            }`}
                          to="v3/epa/landing"
                      ...
                      <li>
                        <Link
                          as={Link}
                          className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "epa-detail" ? "active" : ""
                            }`}
                          to="v3/epa/detail"
                ...
                >
                  <li>
                    <Link
                      ...
                      className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-belanja" ? "active" : ""
                        }`}
                    >
                      <i className="bi bi-circle"></i>
                  ...
                  <li>
                    <Link
                      ...
                      className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-tematik" ? "active" : ""
                        }`}
                    >
                      <i className="bi bi-circle"></i>
                  ...
                  <li>
                    <Link
                      ...
                      className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-kontrak" ? "active" : ""
                        }`}
                    >
                      <i className="bi bi-circle"></i>
                  ...
                  <li>
                    <Link
                      ...
                      className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-uptup" ? "active" : ""
                        }`}
                    >
                      <i className="bi bi-circle"></i>
                  ...
                  <li>
                    <Link
                      ...
                      className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-deviasi" ? "active" : ""
                        }`}
                    >
                      <i className="bi bi-circle"></i>
                  ...
                  <li>
                    <Link
                      ...
                      className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-rkakl" ? "active" : ""
                        }`}
                    >
                      <i className="bi bi-circle"></i>
                  ...
                  <li>
                    <Link
                      ...
                      className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-penerimaan" ? "active" : ""
                        }`}
                    >
                      <i className="bi bi-circle"></i>
                  ...
                  <li>
                    <Link
                      ...
                      className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-revisi" ? "active" : ""
                        }`}
                    >
                      <i className="bi bi-circle"></i>
                      ...
                      >
                        <li>
                          <Link
                            ...
                            className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-spending" ? "active" : ""
                              }`}
                          >
                            <i className="bi bi-circle"></i>
                        ...
                        <li>
                          <Link
                            ...
                            className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-formalokasi" ? "active" : ""
                              }`}
                          >
                            <i className="bi bi-circle"></i>
                        ...
                        <li>
                          <Link
                            ...
                            className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-monitoring" ? "active" : ""
                              }`}
                          >
                            <i className="bi bi-circle"></i>
                          ...
                          <>
                            <li>
                              <Link
                                ...
                                className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-harmonisasi"
                                  ? "active"
                                  : ""
                                  }`}
                              >
                            ...
                            <>
                              <li>
                                <Link
                                  ...
                                  className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-tpid" ? "active" : ""
                                    }`}
                                >
                                  <i className="bi bi-circle"></i>
                          ...
                          <>
                            <li>
                              <Link
                                ...
                                className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-wr" ? "active" : ""
                                  }`}
                              >
                                <i className="bi bi-circle"></i>
                          ...
                          <>
                            <li>
                              <Link
                                ...
                                className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "monitoring-blokir"
                                  ? "active"
                                  : ""
                                  }`}
                              >
                          ...
                          <>
                            <li>
                              <Link
                                ...
                                className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "monev_pnbp" ? "active" : ""
                                  }`}
                              >
                                <i className="bi bi-circle"></i>
                  ...
                  >
                    <li>
                      <Link
                        ...
                        className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-dispensasi" ? "active" : ""
                          }`}
                      >
                        <i className="bi bi-circle"></i>
                    ...
                    <li>
                      <Link
                        ...
                        className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-dispensasi/kppn"
                          ? "active"
                          : ""
                          }`}
                      >
                        ...
                        <>
                          <li>
                            <Link
                              ...
                              className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-referensi" ? "active" : ""
                                }`}
                            >
                              <i className="bi bi-circle"></i>
                          ...
                          <li>
                            <Link
                              ...
                              className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-sp2d" ? "active" : ""
                                }`}
                            >
                              <i className="bi bi-circle"></i>
                          ...
                          <li>
                            <Link
                              ...
                              className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-subsidi" ? "active" : ""
                                }`}
                            >
                              <i className="bi bi-circle"></i>
                          ...
                          <li>
                            <Link
                              ...
                              className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-nadine" ? "active" : ""
                                }`}
                            >
                              {" "}
                              <i className="bi bi-circle"></i>
                  ...
                  >
                    <li>
                      <Link
                        ...
                        className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-dau" ? "active" : ""
                          }`}
                      >
                        <i className="bi bi-circle"></i>
                    ...
                    <li>
                      <Link
                        ...
                        className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-dau25" ? "active" : ""
                          }`}
                      >
                        <i className="bi bi-circle"></i>
                    ...
                    <li>
                      <Link
                        ...
                        className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-upload" ? "active" : ""
                          }`}
                      >
                        <i className="bi bi-circle"></i>
                    ...
                    {role !== "2" && (
                      <li>
                        <Link
                          ...
                          className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-proyeksi" ? "active" : ""
                            }`}
                        >
                          <i className="bi bi-circle"></i>
                    ...
                    {(role === "0" || role === "1" || role === "X") && (
                      <li>
                        <Link
                          ...
                          className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-penilaian" ? "active" : ""
                            }`}
                        >
                          <i className="bi bi-circle"></i>
                ...
                >
                  ...
                  <li>
                    <Link
                      ...
                      className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-team" ? "active" : ""
                        }`}
                    >
                      <i className="bi bi-circle"></i>
                  ...
                  <li>
                    <Link
                      ...
                      className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-change" ? "active" : ""
                        }`}
                    >
                      <i className="bi bi-circle"></i>
                  ...
                  <li>
                    <Link
                      ...
                      className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-dev" ? "active" : ""
                        }`}
                    >
                      <i className="bi bi-circle"></i>
                  ...
                  <li>
                    <Link
                      ...
                      className={` ${darkMode ? "text-white" : ""} ${activeSubmenu === "data-feedback" ? "active" : ""
                        }`}
                    >
                      <i className="bi bi-circle"></i>
