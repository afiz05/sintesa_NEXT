  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <button
        ...
        onClick={handleButtonClick}
        disabled={isButtonDisabled}
        className={`inline-flex items-center px-4 py-2 text-sm font-medium text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 w-1/2 justify-center cursor-pointer ${
          isButtonDisabled
