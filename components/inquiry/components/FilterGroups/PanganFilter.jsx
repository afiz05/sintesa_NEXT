...
import JenisPangan from "../../../referensi_belanja/referensi_inquiryMod/JenisPangan";
...
const PanganFilter = ({ inquiryState }) => {
  ...
  return (
    <div className="w-full p-3 sm:p-4 rounded-2xl bg-gradient-to-r from-green-100 to-lime-100 shadow-sm">
