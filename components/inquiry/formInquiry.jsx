...
// import CutOff from "../referensi_belanja/CutOff";

// Create custom components to replace Bootstrap Row, Col, and Form.Check
...
const Col = ({ xs, sm, md, lg, children, className = "" }) => {
  ...
  const colClass = getColSpan(md || sm || xs || 12);

  return <div className={`${colClass} ${className}`}>{children}</div>;
};

const Form = {
  Check: ({ inline, type, label, value, checked, onChange, ...props }) => (
    <label className="flex items-center cursor-pointer group p-2 rounded-lg hover:bg-content2 transition-all duration-200 border-2 border-transparent hover:border-primary-200">
      <div className="relative flex items-center justify-center">
        <input
          ...
          {...props}
        />
        <div className="w-5 h-5 bg-white border-2 border-gray-300 rounded-full peer-checked:border-primary peer-checked:bg-primary-50 transition-all duration-200 peer-hover:border-primary-400 peer-focus:ring-2 peer-focus:ring-primary-200 flex items-center justify-center shadow-sm">
          <div className="w-2.5 h-2.5 bg-primary rounded-full opacity-0 peer-checked:opacity-100 transition-all duration-200 scale-0 peer-checked:scale-100"></div>
        </div>
      </div>
      <span className="ml-3 text-sm font-medium text-default-700 group-hover:text-primary transition-colors duration-200 select-none">
        {label}
      </span>
    </label>
  ),
...
import JenisLaporan from "../referensi_belanja/JenisLaporan";
...
import Pembulatan from "../referensi_belanja/Pembulatan";
import pilihanData from "../inquiry/pilihanData";

import { getSQL } from "../inquiry/SQL";
import HasilQueryApbn from "./hasilQueryApbn";
...
import KodePN from "../referensi_belanja/KdPN";

import InputPN from "./kondisi/InputPN";
import PnRadio from "./radio/pnRadio";
import KodePP from "../referensi_belanja/KdPP";
...
import KodeKegPP from "../referensi_belanja/KdKegPP";
...
import Kdsoutput from "../referensi_belanja/Kdsoutput";
...
import JenisMP from "../referensi_belanja/JenisMP";
import InputTema from "./kondisi/InputTema";
import TemaRadio from "../inquiry/radio/TemaRadio";
import JenisTematik from "../referensi_belanja/JenisTematik";
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-4 border border-blue-200 dark:border-blue-800">
                  <Thang value={thang} jenlap={jenlap} onChange={handleThang} />
                </div>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-4 border border-purple-200 dark:border-purple-800">
                  <Pembulatan value={pembulatan} onChange={handlePembulatan} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden">
            ...
            <div className="p-4">
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-3">
                <div className="bg-slate-50 dark:bg-slate-700 rounded-lg p-3 hover:bg-slate-100 dark:hover:bg-slate-600 transition-all duration-200">
                ...
                <div className="bg-slate-50 dark:bg-slate-700 rounded-lg p-3 hover:bg-slate-100 dark:hover:bg-slate-600 transition-all duration-200">
                  <pilihanData.SwitchKabkota onChange={getSwitchKabkota} />
                </div>
                <div className="bg-slate-50 dark:bg-slate-700 rounded-lg p-3 hover:bg-slate-100 dark:hover:bg-slate-600 transition-all duration-200">
                ...
                <div className="bg-slate-50 dark:bg-slate-700 rounded-lg p-3 hover:bg-slate-100 dark:hover:bg-slate-600 transition-all duration-200">
                  <pilihanData.SwitchProgram onChange={getSwitchprogram} />
                </div>
                <div className="bg-slate-50 dark:bg-slate-700 rounded-lg p-3 hover:bg-slate-100 dark:hover:bg-slate-600 transition-all duration-200">
            ...
            <Card className="bg-white dark:bg-slate-800 shadow-2xl border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
              <div className="bg-gradient-to-r from-slate-800 to-slate-900 dark:from-slate-700 dark:to-slate-800 px-6 py-4">
              ...
              <CardBody className="p-6 space-y-8">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-700">
                  <div className="grid grid-cols-12 gap-4 items-center">
                    ...
                    <div className="col-span-8">
                      <div className="bg-white dark:bg-slate-700 rounded-lg p-4 border border-blue-200 dark:border-blue-600 shadow-sm">
                        <CutOff
                          value={cutoff}
                          jenlap={jenlap}
                ...
                {KdKegPP && (
                  <>
                    ...
                    <Row>
                      ...
                      <Col xs={4} sm={4} md={4}>
                        *) banyak Kegiatan Prioritas gunakan koma, exclude
                        gunakan tanda !
                      </Col>
                    </Row>
                  </>
                ...
                <div className="mt-8 border-t border-slate-200 dark:border-slate-600 pt-6">
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    <div className="flex justify-center w-full">
                      <Button
                        color="success"
                        size="lg"
                        className="px-8 py-3 font-semibold text-white bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                      ...
                      <Button
                        ...
                        variant="bordered"
                        size="md"
                        className="px-6 py-2 font-medium border-blue-500 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-200"
                      ...
                      >
                        {loadingExcell ? "Downloading..." : "Download Excel"}
                      </Button>
                      ...
                      <div className="relative">
                        <Button
                          ...
                          variant="bordered"
                          size="md"
                          className="px-6 py-2 font-medium border-slate-300 text-slate-600 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all duration-200"
                          onClick={() =>
                        ...
                        {showFormatDropdown && (
                          <div className="absolute top-full left-0 mt-2 w-40 bg-white dark:bg-slate-800 rounded-lg shadow-xl border border-slate-200 dark:border-slate-600 z-20 overflow-hidden">
                            <div className="py-2">
                              <button
                                onClick={() => {
                                  handleGenerateExcel();
                                ...
                                className="w-full text-left px-4 py-2.5 text-sm text-slate-700 dark:text-slate-300 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-colors duration-150 flex items-center gap-2"
                              >
                              ...
                              <button
                                ...
                                className="w-full text-left px-4 py-2.5 text-sm text-slate-700 dark:text-slate-300 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-150 flex items-center gap-2"
                              >
                              ...
                              <button
                                ...
                                className="w-full text-left px-4 py-2.5 text-sm text-slate-700 dark:text-slate-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors duration-150 flex items-center gap-2"
                              >
            ...
            {/* Modal with HeroUI style using Tailwind CSS */}
            {showModalPDF && (
                  ...
                  <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                    ...
                    <div className="flex justify-between items-center mt-6 gap-2">
                      {verified === "TRUE" && (
                        <button
                          type="button"
                          className="inline-flex items-center px-3 py-2 bg-green-100 text-green-700 rounded hover:bg-green-200 focus:outline-none"
                          title={`file akan dikirim ke nomor WhatsApp ${telp}`}
                        >
                      ...
                      <button
                        type="button"
                        className="inline-flex items-center px-3 py-2 bg-red-600 text-white rounded hover:bg-red-700 focus:outline-none"
                        onClick={handleClosePDF}
                      >
                        Tutup
                      </button>
