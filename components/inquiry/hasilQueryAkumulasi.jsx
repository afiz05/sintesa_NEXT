  ...
  const getData = async () => {
    ...
    try {
      const response = await axiosJWT.get(
        process.env.NEXT_PUBLIC_LOCAL_INQUIRYAKUMULASI
          ? `${process.env.NEXT_PUBLIC_LOCAL_INQUIRYAKUMULASI}${encryptedQuery}&page=${page}&limit=${limit}&user=${username}`
          : "",
        {
          headers: {
        ...
        <ModalContent>
          ...
          {loading && (
            <div className="loading-container">
              <Spinner className="loading-spinner" size="md" color="primary" />
            </div>
          )}
